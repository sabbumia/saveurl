      ...
      <div className="max-w-4xl mx-auto relative z-10">
        <div className="bg-white/10 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 p-6 sm:p-8 lg:p-10 transition-all duration-300 hover:shadow-purple-500/20 animate-fadeIn">
          ...
          <div className="text-center mb-6 sm:mb-8 space-y-2 sm:space-y-3">
            {/* <div className="inline-flex items-center justify-center w-14 h-14 sm:w-16 sm:h-16 rounded-2xl bg-gradient-to-br from-purple-500 to-pink-500 mb-3 sm:mb-4 shadow-lg shadow-purple-500/50 animate-bounce">
          ...
          <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 sm:gap-6">
              {/* Source Field */}
              <div className="group relative transform transition-all duration-300 hover:scale-[1.01]" ref={sourceInputRef}>
                <label className="flex items-center gap-2 text-sm font-semibold text-gray-200 mb-2">
                  <Sparkles className="w-4 h-4" />
                ...
                {showSourceSuggestions && filteredSources.length > 0 && (
                  <div className="absolute z-50 w-full mt-1 bg-slate-800/95 backdrop-blur-sm border border-white/20 rounded-xl shadow-xl max-h-48 overflow-y-auto animate-slideDown">
                    {filteredSources.map((source) => (
                      <div
                        key={source}
                        onClick={() => handleSourceSelect(source)}
                        className="px-4 py-2 hover:bg-purple-500/30 cursor-pointer text-white transition-colors text-sm sm:text-base first:rounded-t-xl last:rounded-b-xl"
                      >
              ...
              {/* Category Field */}
              <div className="group relative transform transition-all duration-300 hover:scale-[1.01]" ref={categoryInputRef}>
                <label className="flex items-center gap-2 text-sm font-semibold text-gray-200 mb-2">
